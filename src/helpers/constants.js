...
export const syntechCategoryReplacements = [
  ['Components > Power supplies > Modular power supplies', 'Desktop Components > Power Supplies > Modular Power Supplies'],
  ['Components > Power supplies ', 'Desktop Components > Power Supplies '],
  ['Power > Chargers > Notebook chargers', 'Power Solutions > Notebook Chargers'],
  ['Power > Jump starters', 'Power Solutions > Jump Starters'],
  ['Power > CCTV power supplies', 'Power Solutions > CCTV Power Supplies'],
  ['Power > Chargers > Car chargers', 'Power Solutions > Travel Charger Kits'],
  ['Power > Chargers > Charging trolleys', 'Power Solutions > Charging Trolleys'],
  ['Power > Chargers > USB chargers', 'Power Solutions > Mobile Chargers'],
  ['Power > Foldable solar panels', 'Power Solutions > Foldable Solar Panels'],
  ['Power > Portable power stations', 'Power Solutions > Portable Power Stations'],
  ['Power > Power adapters', 'Power Solutions > Portable Adapters'],
  ['Power > Power banks', 'Power Solutions > Power Banks'],
  ['Power > UPS & inverters', 'Power Solutions > Power Banks'],
  ['Mobile > Styluses', 'Tablets > Accessories'],
  ['Mobile > Tablets', 'Tablets'],
  ['Lifestyle & home tech > Lighting > Lamps', 'Gadgets > Lighting'],
  ['Lifestyle & home tech > Personal grooming', 'Gadgets > Personal Care'],
  ['Lifestyle & home tech > Personal transport > Accessories', 'Gadgets > Scooters'],
  ['Lifestyle & home tech > Personal transport > Scooters & bikes', 'Gadgets > Scooters'],
  ['Lifestyle & home tech', 'Lifestyle & Appliances'],
  ['Bags & luggage', 'Bags Cases & Covers'],
  ['Computers & Peripherals', 'Peripherals'],
  ['Computers > AIO computers', 'Desktop Computers > All-in-One Computers'],
  ...
  ['Networking & security > Dash cams', 'Gadgets > Dash Cams'],
  ['Networking & security > Home security > Wi-Fi cameras', 'CCTV > Network Cameras'],
  ['Networking & security > Controllers & sensors', 'Gadgets > Smart Home'],
  ['Networking & security > Network switches', 'Networking & Wifi > Switches'],
  // Networking & security > Networking accessories         Networking & Wifi > Accessories
  ['Networking & security > Networking accessories', 'Networking & Wifi > Accessories'],
  // Networking & security > Range extenders & access points        Range Extenders & Access Points 
  ['Networking & security > Range extenders & access points', 'Networking & Wifi > Range Extenders & Access Points'],
  ['Networking & security > Routers & mesh', 'Networking & Wifi > Routers & Mesh'],
...
export const micropointCategoryReplacements = [
  ['MEMORY > ACCESSORIES','Storage Media > Memory Card Readers'],
  ...
  ['CABLES : MEDIA > DISPLAY PORT CABLES', 'Cables > Display Cables'],
  ['CABLES : MEDIA > DVI CABLE', 'Cables > DVI Cables'],
  ['CABLES : MEDIA > HDMI CABLES', 'Cables > HDMI Cables'],
  ['CABLES : MEDIA > VGA CABLES', 'Cables > VGA Cables'],
  ['CABLES : MEDIA > MINI DISPLAY PORT', 'Cables > Display Cables'],
  ['CABLES : MEDIA > ACCESSORIES', 'Connectors Adaptors & Converters'],  
  ['CABLES : MEDIA > CABLES', 'Connectors Adaptors & Converters'], 
  ['CABLES : MEDIA > CABLES', 'Cables > HDMI Cables'], 
  ['CABLES : MEDIA > CABLES', 'Cables > HDMI Cables'],   
  ['CABLES : MEDIA > HDMI TO DVI', 'Cables > HDMI Cables'], 
   
  [/CABLES : MEDIA > HDMI$/, 'Cables > HDMI Cables'],  
  ['CABLES : MEDIA > VGA', 'Cables > VGA Cables'], 
  ['CABLES : MEDIA > VGA CABLE CONVERTERS', 'Connectors Adaptors & Converters'], 
  ['CABLES : NETWORK > RCA CABLES', 'Cables > RCA Cables'],
  
  [/CABLES > HDMI$/, 'Cables > HDMI Cables'],
  ['CABLES : NETWORK', 'Peripherals > Cables > Network'],
  ['CABLES : POWER > DEDICATED PLUG POWER CABLES', 'Cables > Power Cables'],
  ['CABLES : POWER > CABLES', 'Cables > Power Cables'],
  ['CABLES : POWER > NORMAL PLUG POWER CABLES', 'Cables > Power Cables'],
  ['CABLES : POWER > OTHER POWER CABLES', 'Cables > Power Cables'],
  ['CABLES > NORMAL PLUG POWER CABLES', 'Cables > Power Cables'],
  ['CABLES > OTHER POWER CABLES', 'Cables > Power Cables'],  
  ['CABLES : POWER > SPECIAL CONNECTOR', 'Cables > Power Cables'],  
  ['CABLES > DISPLAY PORT CABLES', 'Cables > Display Cables'],
  ['CABLES > PRINTER', 'Cables > Printer Cables'],
  ['CABLES > HDMI CABLES', 'Cables > HDMI Cables'],
  ...
  ['GAMING > MOUSE PAD', 'Gaming > Mouse Pads'],
  ...
  ['MOUSE > WIRELESS', 'Peripherals > Mice > Office Mice'],
  ...
  ['POWER SUPPLY > POWER SUPPLY', 'Power Solutions > Computer Power Supplies'],
  ...
  ['SOUND > WIRELESS', 'Peripherals > Computer Audio > Microphones'],
  ...
  [/HDMI Products > Cables/gi, 'Peripherals > Cables > HDMI Cables'],
...
export const esquireCategoryReplacements = [
  ...
  ['Broadband Routers -3G/LTE', 'Networking & Wifi > Routers > 3G/LTE Routers'],
  ...
  ['Cable: Power', 'Cables > Power Cables,Power Solutions > Power Cables'],
  ...
  ['Ink Cartridges-Generic', 'Printers > Cartridges > Ink Cartridges'],
  ['Ink Cartridges-Original', 'Printers > Cartridges > Ink Cartridges'],
  ['Ink and Toners-Generic', 'Printers > Cartridges > Toner Cartridges'],
  ['Ink and Toners-Original', 'Printers > Cartridges > Toner Cartridges'],
